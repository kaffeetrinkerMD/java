...
public class Kunde {
	...
	/*
	 * Die Methode toString kann nur einmal überschrieben werden.
	 * Jeder andere Änderung (z.B. andere Signatur) würde von Java ignoriert werden.
	 * 
	 * Lösungsmöglichkeit:
	 * 
	 * 	- mit privaten Klasseneigenschaften arbeiten und diese in einem switch-case-Block verwenden
	 */
	
	/*public class KlasseA{
	    
	    private int modifikatorToString = methode();
	    
	    ...
	    
	    public String toString() {
		
		switch (modifikatorToString) {
		case 1:
		{
		    ...;
		    break;
